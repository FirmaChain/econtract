...
<제1장 총칙>
제1조 (목적)
본 약관은 주식회사 피르마솔루션즈(이하 "회사"라 함)가 제공하는 Stabledocs 서비스의 이용과 관련하여 회사와 회원 간의 권리, 의무 및 책임사항, 기타 필요한 사항을 정함을 목적으로 합니다.
제2조 (용어의 정의)
① 본 약관에서 사용하는 용어의 정의는 다음과 같습니다. 
1. "서비스"란 회사가 제공하는 블록체인 기반 전자계약 플랫폼 Stabledocs 서비스를 말합니다.
...
제3조 (약관의 효력 및 적용과 변경)
① 회사는 본 약관의 내용을 이용자가 알 수 있도록 회사에서 운영하는 홈페이지(https://stabledocs.com, 이하 "홈페이지"라 함)에 게시하거나 연결화면을 제공하는 방법으로 회원에게 공지합니다.
